...
The Bioconductor ecosystem integrates the methods of microbiome data science
...
data combinations [@huber2015] and are widely adopted in various
research fields (@fig-bioc_packages). They have been implemented through specialized
object-oriented classes that integrate multiple data elements into
a single structure known as a *data container*
[@chambers2014]. The SummarizedExperiment (SE) class [@huber2015; @morgan2025] is
...
| miaData                 | [@benedetti2026a]          | 9          | 20,404    |
| microbiomeDataSets      | [@microbiomedatasets]      | 6          | 19,100    |
| HMP2data                | [@hmp2data]                | 3          | 11,493    |
| HoloFoodR$^a$           | [@rogers2024; @borman2025] | 9          | 9,990     |
...
#|   source code for the benchmarking analysis is openly available
#|   [@benedetti2026b]."
#| fig-width: 12
#| fig-height: 14
...
v2&ndash;4 and HUMAnN v3 [@mciver2017], Mothur [@schloss2009], QIIME 2
...
[@nickols2026], and radEmu [@clausen2024]. Leveraging the interoperability of
...
#|   series dataset openly available via microbiomeDataSets [@microbiomedatasets].
...
p_alpha2 <- plotColData(
    tse, y = "faith", x = "Age_Months", colour_by = "Country"
) +
...
All datasets used in this article were made publicly available and can be
accessed from R through the mia ecosystem [@benedetti2026a].

## Code availability

This article presented v1.1.1 of the OMA book (2026-05-07) published at
[https://bioconductor.org/books/release/OMA](https://bioconductor.org/books/release/OMA),
which is dependent on R v4.6 and Bioconductor v3.24. Analytical scripts and
related results of the benchmarking analysis were deposited on Zenodo
[@benedetti2026b].
