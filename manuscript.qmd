...
domains, such as single-cell omics (OSCA book [@amezquita2020]) and spatial transcriptomics (OSTA book [@crowell2025OSTA]). These resources use standard data containers to support statistical programming on interlinked multi-table datasets.
