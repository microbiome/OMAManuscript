...
sizes but scales well with increasing sample sizes. It should be noted
that our benchmark analysis focuses on methods that are currently
accessible via R/Bioconductor, and thus benefit from the broader
interoperability of this framework. In addition, we plan to incorporate
other recently developed, highly optimized methods, such as DartUniFrac
\citep{zhao2026}, which provides massive scalability enhancements for
Unifrac-based phylogenetic distance calculation. In the future,
optimizing time and memory consumption will represent a key area of
further development in the (Tree)SE framework for microbiome data
science.
