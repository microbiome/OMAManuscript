...
challenges of integrating heterogeneous and high-dimensional obsevations
across multiple data modalities into scalable and reproducible workflows
...
\citep{amezquita2020} and SpatialExperiment
\citep[\citet{righelli2022}]{crowell2025} classes.
...
methods from scikit-bio Python library \citep{aton2025} which supports
...
reached around 10,000 samples with all methods. At a feature set size to
...
\pandocbounded{\includegraphics[keepaspectratio]{manuscript_files/figure-pdf/fig-benchmarking-1.pdf}}
...
bridge the gap between the originl data processing, other tools, and
...
\{\citet{nickols2026}{]} and the probabilistic DiPPER \citep{pelto2026}.
...
for instance, for instance, MaAsLin3 \citep{nickols2026} and many other
Bioconductor libraries support metatranscriptomics analysis, notame
package \citep{klavus2020} for metabolome analyses recently added SE
support, and the R for Mass Spectrometry (R4MS) project provides many
...
\textbf{Multi-modal integration.} Key feature of the ecosystem is to
provide the infrastructure supporting the integration microbial
...
\citep[\citet{lee2023}]{salehi2025}, host genomes \citep{qin2022}, or
...
Examplesinclude association-based approaches, latent variable models,
...
general, mia supports flexible statistical programming framework. Thus,
it can be used to incorporate more specialized microbiome analysis
...
emerging disciplines. Importantly, our framework can be also linked to
...
\citep{aton2025}, a Python-based ecosystem. Whereas scikit-bio benefits
...
available via microbiomeDataSets (Bioconductor package). This dataset
consists of longitudinal 16S rRNA gut microbiome data from infant fecal
samples collected in Finland, Bangladesh, and Bolivia
...
well as analysis templates for users without strong programming
